...
import { Mail, Phone, UserCircle, Briefcase, Hash } from "lucide-react";
        ...
        <CardContent className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <Badge variant="default" className="mt-1">변호사</Badge>
            </div>
          </div>
        </CardContent>
      </Card>
          ...
          <div className="space-y-3">
            ...
            {profile.bar_number && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-muted-foreground">변호사 등록번호</p>
                  <p className="text-sm font-medium text-navy-900">
                    {profile.bar_number}
                  </p>
                </div>
